    ...
    return (
      <div className="create_account_screen">
        ...
        <h2 class="formTitle" align="center"> Thesis Project </h2>
          <p class="formTitle">Sign up to check-in and chat with others.</p>
          <form  className="create_account_form" name="regForm" onSubmit={this.saveAndContinue}>
            <Input
              text="First Name"
              type="text"
              ref="nameFirst"
        ...
        <div class="form-group" >
          ...
          />
            ...
            Or login through Google! <span id="signInButton"></span>
        </div>
